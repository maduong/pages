<?php namespace Edutalk\Base\Pages\Http\Middleware;

use \Closure;
use Edutalk\Base\Pages\Criterias\Filters\FilterPagesCriteria;
...
class BootstrapModuleMiddleware
{
    ...
    public function handle($request, Closure $next, ...$params)
    {
        ...
        admin_quick_link()->register('page', [
            'title' => trans('edutalk-pages::base.page'),
    ...
    protected function registerMenuDashboard()
    {
        ...
        dashboard_menu()->registerItem([
            ...
            'priority' => 1,
            'parent_id' => null,
            'heading' => trans('edutalk-pages::base.admin_menu.pages.heading'),
            'title' => trans('edutalk-pages::base.admin_menu.pages.title'),
    ...
    protected function registerMenu()
    {
         ...
         */
        menus_management()->registerWidget(trans('edutalk-pages::base.admin_menu.pages.title'), 'page', function () {
    ...
    protected function registerSettings()
    {
        cms_settings()
            ->addSettingField('default_homepage', [
                ...
                'type' => 'select',
                'priority' => 0,
                'label' => trans('edutalk-pages::base.settings.default_homepage.label'),
                'helper' => trans('edutalk-pages::base.settings.default_homepage.helper')
            ], function () {
                /**
