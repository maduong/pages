<?php namespace Edutalk\Base\Pages\Http\DataTables;
...
class PagesListDataTable extends AbstractDataTables
{
    ...
    public function headings()
    {
        return [
            ...
            'page_template' => [
                'title' => trans('edutalk-core::datatables.heading.page_template'),
                'width' => '15%',
            ],
            'status' => [
    ...
    protected function fetchDataForAjax()
    {
        return datatable()->of($this->model)
            ...
            ->editColumn('page_template', function ($item) {
                return config('edutalk-templates.page.' . $item->page_template);
            })
            ...
            ->addColumn('actions', function ($item) {
                ...
                /*Buttons*/
                $editBtn = link_to(route('admin::pages.edit.get', ['id' => $item->id]), trans('edutalk-core::datatables.edit'), ['class' => 'btn btn-sm btn-outline green']);
