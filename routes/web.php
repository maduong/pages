...
$namespace = 'Edutalk\Base\Pages\Http\Controllers';
 ...
 * Front site
 */
foreach (config('edutalk-pages.custom_route_locations.web', []) as $file) {
    require $file;
}
foreach (config('edutalk-pages.public_routes.web', []) as $method => $routeInfo) {
